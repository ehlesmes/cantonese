...
const refWords = JSON.parse(fs.readFileSync(REF_PATH, "utf8"));
const dictEntries = JSON.parse(fs.readFileSync(DICT_PATH, "utf8"));

// Create a lookup set of characters taught in the course
const taughtChars = new Set(dictEntries.map((entry) => entry.char.trim()));
