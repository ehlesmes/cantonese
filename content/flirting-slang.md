...
description: >
  Explore Cantonese slangs for secret crushes, ideal partners, and the unique
  local metaphor of 'soldiering'.
---

In this chapter, we will learn about the dynamics of flirting and the unique
colloquial terms for crushes and unrequited admiration in Hong Kong.

---

## 1. The Dynamics of Flirting & "Soldiering"
...
## 2. Situational Dialogue: The Goddess and Her Soldier
...
Test your understanding of flirting terms and soldiering slang in Cantonese.
...
explanation: |
  `收兵[sau1bing1|to collect platonic admirers]` is the colloquial verb for collecting admirers, and `囉[lo1|sentence-final particle showing obviousness, resignation, or 'of course']` is the SFP indicating obviousness.
```

```exercise
question: |
  What is the slang term for a platonic admirer who is led on and does favors for their crush?
  A) 女神[neoi5san4|goddess]
  B) 男神[naam4san4|male god]
  C) 兵[bing1|platonic admirer who is led on]
answer: C
explanation: |
  `兵[bing1|soldier]` is the colloquial term for an admirer who does favors for their crush in hopes of dating them.
```
