...
1. **The Philosophy of "Making a Living"**: Understanding the cultural
   significance of `搵食[wan2sik6|to make a living]`, and mastering daily office
   routines using standard terms like `公司[gung1si1|company]`,
...
3. **Overtime, Salaries, and Firing**: Expressing working overtime using
   ...
   `人工[jan4gung1|salary]`, requesting a raise using
   `加人工[gaa1jan4gung1|to get a raise]`, and describing getting fired using
   the famous metaphor `炒魷魚[caau2jau4jyu2|to get fired]`.

Mastering these terms will make you sound like an authentic Hong Kong
professional and help you participate in daily office gossip and lunch chats.

---

## 1. Making a Living: `搵食[wan2sik6|to make a living]`

In Cantonese culture, work is closely tied to the concept of food. The most
common colloquial way to say "making a living" or "earning a livelihood" is
`搵食[wan2sik6|to make a living]`, which literally translates to "seeking food."
When someone asks you why you work so hard, a standard self-deprecating reply is
that it is all for `搵食[wan2sik6|to make a living]`.

### Core Office Routines

To talk about daily routines at the `公司[gung1si1|company]`, you will use
several high-frequency verbs:

- `返工[faan1gung1|to go to work]`: Literally "returning to work."
- `放工[fong3gung1|to finish work]`: Literally "releasing work," meaning getting
  off shift or leaving the office for the day.
- `同事[tung4si6|colleague]`: The standard term for coworkers.
...
> [!NOTE] Unlike the formal term `工作[gung1zok3|work]`, which can be a noun or
> verb, `返工[faan1gung1|to go to work]` and `放工[fong3gung1|to finish work]`
> are spoken action verbs. You "`返工[faan1gung1|to go to work]`" in the morning
> and "`放工[fong3gung1|to finish work]`" in the evening.
...
### 3. `Hea[hea1|to chill / slack off]` (To Procrastinate / Chill)

`Hea[hea1|to chill / slack off]` is perhaps the most famous modern Cantonese
slang term. It has no standard Chinese character and is written in Roman
alphabet. It is incredibly versatile and can mean to hang out, chill, do things
...
## 3. Overtime, Salaries, and Career Moves: `OT[o1ti1|to work overtime]`, `人工[jan4gung1|salary]`, `加人工[gaa1jan4gung1|to get a raise]`, and `炒魷魚[caau2jau4jyu2|to get fired]`

To talk about the professional realities of compensation and job transitions,
Cantonese uses several colorful and loanword-based terms.

### 1. Working Overtime: `OT[o1ti1|to work overtime]`

In Hong Kong's notoriously high-intensity work environment, working overtime is
extremely common. Cantonese speakers simply use the English initials "OT" as a
...
### 2. Salaries and Raises: `人工[jan4gung1|salary]` and `加人工[gaa1jan4gung1|to get a raise]`
...
### 3. Getting Fired: `炒魷魚[caau2jau4jyu2|to get fired]`

One of the most famous food-related slang terms in Cantonese is
`炒魷魚[caau2jau4jyu2|to get fired]`, which literally means "to stir-fry squid."

This term dates back to old Hong Kong when migrant workers lived at their
workplaces and slept on rolled-up mats. When they were dismissed, they had to
roll up their mats and pack their belongings. Since squid curls up when
stir-fried, the rolling up of the sleeping mat was likened to a curled-up fried
...
In this scene, Wing-sum (A) and Wing-kit (B) discuss some recent office gossip
during a coffee break, complain about their heavy workload, and share their
...
Test your understanding of Cantonese workplace slang and office expressions.
...
answer: C
explanation: |
  `炒魷魚[caau2jau4jyu2|to get fired]` literally translates to "stir-fry squid," which curls up when cooked, resembling the rolled-up sleeping mats of dismissed workers packing their bags.
```
