...
description: >
  ...
  coeng3go1. Learn how to parse and separate them with aspect markers,
...
actions, past completions, or duration, Cantonese speakers literally split these
compounds in half and insert grammar markers directly between them.
...
## 3. Situational Dialogue: A Weekend Plan
...
B: 我[ngo5|I / me] 唔[m4|not / no (negative prefix)] 識[sik1|to know / be familiar with / speak (a language)] 唱歌[coeng3go1|to sing] 嘛[maa3|sentence-final particle indicating a statement is an obvious truth or reminder]！ 我[ngo5|I / me] 今晚[gam1maan5|tonight] 去[heoi3|to go] 跳舞[tiu3mou5|to dance] 呀[aa3|sentence-final particle softening statements, making questions friendly]。
   === I don't know how to sing, obviously! I'm going dancing tonight.
A: 哇[waa1|wow / whoa]，你[nei5|you] 又[jau6|also / again] 跑步[paau2bou6|to run / jog] 又[jau6|also / again] 跳舞[tiu3mou5|to dance]，好[hou2|very / quite / extremely] 忙[mong4|busy] 喎[wo3|sentence-final particle indicating reported speech, surprise, or warning]！
   === Wow, you both jog and dance, that's very busy!
B: 係呀[hai6aa3|yes]，我[ngo5|I / me] 跑[paau2|to run] 咗[zo2|verbal aspect suffix indicating completed action (perfective aspect)] 兩[loeng5|two / pair (used with classifiers)] 個[go3|general measure word / individual / unit] 鐘頭[zung1tau4|hour] 步[bou6|step / pace] 呀[aa3|sentence-final particle softening statements, making questions friendly]，而家[ji4gaa1|now / currently] 好[hou2|very / quite / extremely] 攰[gui6|tired / fatigued] 喇[laa3|sentence-final particle indicating a change of state or already]。
   === Yes, I jogged for two hours, and now I'm very tired already.
```
...
explanation: |
  The verb `游水[jau4seoi2|to swim]` is a split-verb. The completed aspect marker `咗[zo2|verbal aspect suffix indicating completed action (perfective aspect)]` must be inserted between `游[jau4|to swim]` and `水[seoi2|water]`, resulting in `游[jau4|to swim]` `咗[zo2|verbal aspect suffix indicating completed action (perfective aspect)]` `水[seoi2|water]`.
```

```exercise
question: |
  Fill in the blank to say "He is jogging right now":
  佢[keoi5|he / she / it] 跑[paau2|to run] ________ 步[bou6|step / pace] 呀[aa3|sentence-final particle softening statements, making questions friendly]。
answer: 緊[gan2|verbal aspect suffix indicating an action in progress (continuous aspect)]
explanation: |
  The verb `跑步[paau2bou6|to run / jog]` is a split-verb. To indicate an action in progress, we insert the continuous aspect suffix `緊[gan2|verbal aspect suffix indicating an action in progress (continuous aspect)]` between the verb part `跑[paau2|to run]` and the object part `步[bou6|step / pace]`.
```
