...
description: >
  Master the structures for describing ongoing actions using the continuous
...
## 1. Ongoing Action: Suffix `緊[gan2|verbal aspect suffix indicating an action in progress (continuous aspect)]`

When you want to describe an action that is happening right now in Cantonese,
you attach the verbal aspect suffix
`緊[gan2|verbal aspect suffix indicating an action in progress (continuous aspect)]`
directly to the verb. This is equivalent to the English "-ing" or the Mandarin
_zhèngzài_.
...
```cantonese
佢[keoi5|he / she / it] 睇[tai2|to look / see / watch / read] 緊[gan2|verbal aspect suffix indicating an action in progress (continuous aspect)] 書[syu1|book] 呀[aa3|sentence-final particle softening statements, making questions friendly]。
===
...
## 2. Verb-Object Splitting with `緊[gan2|verbal aspect suffix indicating an action in progress (continuous aspect)]`

Many high-frequency Cantonese verbs are actually **compound verbs** consisting
of a verb and a default noun object (Verb-Object pairs). Examples include:
...
> `緊[gan2|verbal aspect suffix indicating an action in progress (continuous aspect)]`,
> you must place it **between the verb and the object**, never at the end of the
> compound.
...
===
A typhoon is raging outside right now!
```
...
3. **Low-effort / easy** (when used as an adjective, e.g., "a hea job").

When combined with our continuous aspect marker, it describes the ultimate state
of chilling out:
...
## 4. Situational Dialogue: Checking In

Ka-ho (A) calls Wing-yan (B) to see what she is doing. B is slacking off in her
...
Test your understanding of the continuous aspect suffix and slang `Hea`:

```exercise
question: |
  Fill in the blank to say "He is reading a book right now":
  佢[keoi5|he / she / it] 睇[tai2|to look / watch / read] ________ 書[syu1|book] 呀[aa3|sentence-final particle softening statements, making questions friendly]。
answer: 緊[gan2|verbal aspect suffix indicating an action in progress (continuous aspect)]
explanation: The continuous aspect suffix `緊[gan2|verbal aspect suffix indicating an action in progress (continuous aspect)]` attaches directly to the verb `睇[tai2|to look / watch / read]` to show the action is in progress.
```
