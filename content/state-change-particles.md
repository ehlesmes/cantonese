...
## 2. Change of State: `喇[laa3|sentence-final particle indicating a change of state or already]`

The particle
`喇[laa3|sentence-final particle indicating a change of state or already]` is
the Cantonese SFP marking a **change of state**—indicating that a situation has
...
explanation: The SFP 喇[laa3|sentence-final particle indicating a change of state or already] expresses a change of state (now/already). When paired with 咗[zo2|verbal aspect suffix indicating completed action (perfective aspect)], it shows that the action has already occurred.
```
...
answer: 你[nei5|you] 遲到[ci4dou3|to be late / arrive late] 喇喎[laa3wo3|sentence-final particle combination indicating warning, sudden realization, or change of state]！
