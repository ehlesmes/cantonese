...
description: >
  Learn spoken Cantonese verbs for dating, confessions, and the famous Hong Kong
  university relationship status codes.
---
...
- `拍拖[paak3to1|to date]` -> `拍[paak3|to clap / pat / beat]`
  `咗[zo2|completed]` `拖[to1|to pull / drag / tow]`
...
## 2. Situational Dialogue: A Classmate "Out of Pool"
...
answer: B
explanation: |
  A0[ei1ling4|single and never dated] represents a student who is Available (single) and has experienced zero (0) relationships.
```
