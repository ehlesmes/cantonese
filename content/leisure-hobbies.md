...
question: |
  ...
  B) 打卡[daa2kaat1|to check-in]
  C) 睇波[tai2bo1|to watch ball games]
  D) 聽歌[teng1go1|to listen to music]
answer: B
explanation: |
  `打卡[daa2kaat1|to check-in]` is the colloquial slang meaning to visit a popular place and take photos to show off or check-in on social media.
```
