...
description: >
  Master existential verbs jau and mou to express presence or absence, and
  locate specific subjects using the locative preposition hai.
---

In this lesson, we will learn how to describe where objects and places are in
Cantonese, focusing on stating presence and pinpointing locations.
...
Below is a simple dialogue where A is looking for their keys and B indicates
where they are.
...
B: 你[nei5|you] 個[go3|unit] 銀包[ngan4baau1|wallet] 喺[hai2|at / in / on] 呢度[ni1dou6|here] 呀[aa3|particle]。
   === Your wallet is here.
A: 喺[hai2|at / in / on] 呢度[ni1dou6|here] 呀[aa3|particle]？ 噉[gam2|then / in that case / so] 我[ngo5|I] 條[tiu4|classifier for long, thin objects] 鎖匙[so2si4|key] 呢[ne1|particle]？ 喺[hai2|at / in / on] 邊度[bin1dou6|where] 呀[aa3|particle]？
   === It's here? Then what about my keys? Where are they?
B: 鎖匙[so2si4|key] 喺[hai2|at / in / on] 廚房[cyu4fong2|kitchen] 呀[aa3|particle]。
   === The keys are in the kitchen.
A: 廚房[cyu4fong2|kitchen] 喺[hai2|at / in / on] 邊度[bin1dou6|where] 呀[aa3|particle]？
...
Review the existential and locative prepositions introduced in this chapter:

```exercise
question: |
  Which of the following sentences correctly translates "Is there a restroom here?"?
  A) 呢度[ni1dou6|here] 有冇[jau5mou5|is there] 廁所[ci3so2|restroom] 呀[aa3|particle]？
  B) 呢度[ni1dou6|here] 喺[hai2|at] 邊度[bin1dou6|where] 呀[aa3|particle]？
  C) 廁所[ci3so2|restroom] 喺[hai2|at] 邊度[bin1dou6|where] 呀[aa3|particle]？
answer: A
explanation: To ask about the existence of something in a location, we use the A-not-A existential pattern [Location] + 有冇[jau5mou5|is there] + [Noun] + 呀[aa3|particle].
```

```exercise
question: |
  Translate "I am at the office" into Cantonese with correct annotations:
answer: 我[ngo5|I / me] 喺[hai2|at / in / on] 公司[gung1si1|company / office] 呀[aa3|sentence-final particle softening statements, making questions friendly]。
explanation: To locate a specific subject, we use the pattern [Subject] + 喺[hai2|at / in / on] + [Location].
```
