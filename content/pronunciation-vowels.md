...
description: >
  Master vowel length distinctions, silent stop consonants, and essential
  conversational exclamations in spoken Cantonese.
---

In Cantonese, the physical length of a vowel and the way final consonants are
released or held are critical to being understood. In this lesson, we will focus
on these sound characteristics and key conversational exclamations.

---

## 1. Vowel Length Distinction: `aa` vs `a`
...
## 2. Silent Stop Consonant Endings (`-p`, `-t`, `-k`)
...
Test your understanding of the vowel lengths and stop endings introduced in this
chapter:
