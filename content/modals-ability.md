---
id: modals-ability
title: "Modals of Ability & Potential Suffixes"
description: >
  Master the modal verbs sik, ho2ji5, and wui5 for expressing capability and
  permission, and learn to use potential suffixes dak and m4dou2.
---

In this chapter, we will learn how to express different types of capability and
permission using Cantonese modal verbs, and how to use potential suffixes
directly with verbs to indicate physical feasibility.
...
## 2. Physical Feasibility and Obstacles: Potential Suffixes `得[dak1|particle expressing permission, possibility, capability, or adverbial degree]`, `唔得[m4dak1|cannot / not allowed / physically bad to do]`, and `唔到[m4dou2|cannot / unable to manage to / fail to]`
...
- `唔[m4|not]` `食[sik6|to eat]`
  `得[dak1|particle expressing permission, possibility, capability, or adverbial degree]`
  — not allowed to eat / shouldn't be eaten.
...
A: 噉[gam2|then] 你[nei5|you] 聽日[ting1jat6|tomorrow] 會唔會[wui5 m4 wui5|will or will not] 去[heoi3|to go] 呀[aa3|particle]？
   === Then will you go tomorrow?
B: 會[wui5|will] 呀[aa3|particle]，聽日[ting1jat6|tomorrow] 去[heoi3|to go] 得[dak1|ready to go / able to go] 啦[laa1|particle]！
...
Review the modals of ability and potential suffixes:
