---
id: dining-slang
title: "Diner Slang & Completed Actions"
description: >
  Master diner slangs like white rice, talk about completed actions with the
  aspect marker zo, and describe basic emotions and physical states.
---

In this lesson, we will focus on authentic restaurant slang, expressing
completed actions using aspect suffixes, and describing emotions and physical
states in Cantonese.
...
## 1. Local Café Slang: Ordering a `靚仔[leng3zai2|handsome boy / plain white rice (restaurant slang)]`
...
## 2. Completed Actions: Perfective Suffix `咗[zo2|verbal aspect suffix indicating completed action (perfective aspect)]`
...
## 4. Situational Dialogue: A Lively Café Lunch
...
Review the food culture and completed actions introduced in this chapter:
