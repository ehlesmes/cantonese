...
| :--- | :--- | :--- | :--- | :--- |
| **呀** | `aa3` | particle / sentence-final particle softening statements, making questions friendly | `00-pronunciation-jyutping.md` | 212 |
...
| **俾** | `bei2` | to give / for / by / to give | `10-hypotheticals-conditionals.md` | 19 |
...
| **幫** | `bong1` | for | `16-workplace-slang.md` | 2 |
...
| **錢** | `cin2` | money | `02-shopping-slang.md` | 10 |
...
| **都** | `dou1` | also / both / all | `11-narrative-cohesion.md` | 15 |
...
| **搞掂** | `gaau2dim6` | done / finished / settled / resolved | `02-shopping-slang.md` | 16 |
| **雞** | `gai1` | chicken | `00-pronunciation-jyutping.md` | 11 |
| **今日** | `gam1jat6` | today | `00-pronunciation-jyutping.md` | 26 |
| **噉** | `gam2` | then / in that case / so | `05-time-continuous.md` | 10 |
| **咁** | `gam3` | so / such / to this degree / then | `07-comparatives-descriptors.md` | 15 |
...
| **嘅** | `ge3` | particle / possessive particle / nominalizing particle / final assertive particle | `00-pronunciation-jyutping.md` | 43 |
...
| **喺** | `hai2` | at / in / on / at / in / on (locative preposition) | `04-existentials-places.md` | 47 |
| **喺度** | `hai2dou6` | here | `16-workplace-slang.md` | 1 |
| **係** | `hai6` | to be / to be (am/is/are) / yes | `01-greetings.md` | 46 |
...
| **要** | `jiu3` | to want / need / must / demand / need / have to | `02-shopping-slang.md` | 23 |
...
| **佢** | `keoi5` | he / she / it | `01-greetings.md` | 59 |
| **佢哋** | `keoi5dei6` | they / them | `01-greetings.md` | 11 |
| **傾** | `king1` | to talk / chat | `09-split-verbs-idioms.md` | 1 |
| **啦** | `laa1` | particle / sentence-final particle suggesting, requesting, or encouraging action | `00-pronunciation-jyutping.md` | 83 |
...
| **唔好** | `m4hou2` | don't | `16-workplace-slang.md` | 1 |
...
| **你** | `nei5` | you | `00-pronunciation-jyutping.md` | 99 |
...
| **我** | `ngo5` | I / I / me | `00-pronunciation-jyutping.md` | 176 |
| **我哋** | `ngo5dei6` | we / us | `01-greetings.md` | 21 |
...
| **食** | `sik6` | to eat | `00-pronunciation-jyutping.md` | 35 |
...
| **想** | `soeng2` | want to / to want to / would like to / think / to want / would like to | `00-pronunciation-jyutping.md` | 35 |
...
| **聽講** | `ting1gong2` | to hear of / be told | `15-rhetorical-questions.md` | 3 |
| **聽日** | `ting1jat6` | tomorrow | `05-time-continuous.md` | 12 |
| **跳** | `tiu3` | to jump / leap / dance | `09-split-verbs-idioms.md` | 1 |
| **跳舞** | `tiu3mou5` | to dance | `09-split-verbs-idioms.md` | 2 |
| **同** | `tung4` | with / same as / and / with / and | `07-comparatives-descriptors.md` | 10 |
| **同埋** | `tung4maai4` | and / with / together with | `02-shopping-slang.md` | 9 |
| **同事** | `tung4si6` | colleague | `16-workplace-slang.md` | 3 |
| **哇** | `waa1` | wow / whoa | `09-split-verbs-idioms.md` | 3 |
| **話** | `waa6` | to say / tell / words / speech / to scold | `08-particles-nuance.md` | 20 |
...
| **真係** | `zan1hai6` | really / truly | `08-particles-nuance.md` | 15 |
| **走** | `zau2` | to leave / go / run | `08-particles-nuance.md` | 3 |
| **就** | `zau6` | then / right away / immediately | `10-hypotheticals-conditionals.md` | 18 |
| **啫** | `ze1` | sentence-final particle meaning 'only', 'just', or downplaying something / only / just | `06-ability-experience.md` | 17 |
...
| **咗** | `zo2` | verbal aspect suffix indicating completed action (perfective aspect) / completed aspect | `03-dining-out.md` | 69 |
...
| **鍾意** | `zung1ji3` | to like / prefer | `06-ability-experience.md` | 3 |
