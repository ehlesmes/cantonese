...
| :--- | :--- | :--- | :--- | :--- |
| **呀** | `aa3` | particle / sentence-final particle softening statements, making questions friendly | `00-pronunciation-jyutping.md` | 225 |
...
| **今日** | `gam1jat6` | today | `00-pronunciation-jyutping.md` | 29 |
...
| **嗰度** | `go2dou6` | there | `04-existentials-places.md` | 4 |
| **嗰個** | `go2go3` | that one | `02-shopping-slang.md` | 8 |
| **個** | `go3` | general measure word / individual / unit / measure word for general items | `02-shopping-slang.md` | 44 |
...
| **喺** | `hai2` | at / in / on / at / in / on (locative preposition) | `04-existentials-places.md` | 52 |
| **喺度** | `hai2dou6` | here | `16-workplace-slang.md` | 1 |
| **係** | `hai6` | to be / to be (am/is/are) / yes | `01-greetings.md` | 47 |
...
| **去** | `heoi3` | to go | `04-existentials-places.md` | 47 |
...
| **好** | `hou2` | good / fine / very / quite | `01-greetings.md` | 50 |
...
| **一** | `jat1` | one | `02-shopping-slang.md` | 18 |
...
| **佢** | `keoi5` | he / she / it | `01-greetings.md` | 60 |
| **佢哋** | `keoi5dei6` | they / them | `01-greetings.md` | 11 |
| **傾** | `king1` | to talk / chat | `09-split-verbs-idioms.md` | 1 |
| **啦** | `laa1` | particle / sentence-final particle suggesting, requesting, or encouraging action | `00-pronunciation-jyutping.md` | 95 |
...
| **靚** | `leng3` | high quality / pretty / beautiful / handsome / high quality / pretty / beautiful / good-looking | `03-dining-out.md` | 13 |
...
| **兩** | `loeng5` | two / pair (used with classifiers) | `02-shopping-slang.md` | 32 |
...
| **唔該** | `m4goi1` | excuse me / excuse me / please / thank you (for service or help) | `02-shopping-slang.md` | 28 |
...
| **你** | `nei5` | you | `00-pronunciation-jyutping.md` | 101 |
...
| **我** | `ngo5` | I / I / me | `00-pronunciation-jyutping.md` | 180 |
...
| **呢度** | `ni1dou6` | here | `02-shopping-slang.md` | 27 |
...
| **想** | `soeng2` | want to / to want to / would like to / think / to want / would like to | `00-pronunciation-jyutping.md` | 40 |
...
| **同埋** | `tung4maai4` | and / with / together with | `02-shopping-slang.md` | 10 |
...
| **真係** | `zan1hai6` | really / truly | `08-particles-nuance.md` | 16 |
...
| **咗** | `zo2` | verbal aspect suffix indicating completed action (perfective aspect) / completed aspect | `03-dining-out.md` | 70 |
...
| **鍾意** | `zung1ji3` | to like / prefer | `06-ability-experience.md` | 4 |
