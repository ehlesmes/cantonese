...
| :--- | :--- | :--- | :--- | :--- |
| **呀** | `aa3` | particle / sentence-final particle softening statements, making questions friendly | `00-pronunciation-jyutping.md` | 269 |
| **阿** | `aa3` | prefix | `16-workplace-slang.md` | 1 |
| **阿明** | `aa3 ming4` | Ah Ming | `22-entertainment-nightlife.md` | 2 |
...
| **晏** | `aan3` | late | `22-entertainment-nightlife.md` | 1 |
...
| **俾** | `bei2` | to give / for / by / to give / to give / for / let / allow | `10-hypotheticals-conditionals.md` | 23 |
| **邊** | `bin1` | which | `07-comparatives-descriptors.md` | 1 |
| **邊度** | `bin1dou6` | where | `04-existentials-places.md` | 11 |
...
| **得** | `dak1` | particle expressing permission, possibility, capability, or adverbial degree | `06-ability-experience.md` | 18 |
...
| **多** | `do1` | many / much / more | `07-comparatives-descriptors.md` | 3 |
| **多謝** | `do1ze6` | thank you (for a gift, compliment, or hospitality) / thank you (for a gift) | `02-shopping-slang.md` | 5 |
...
| **返** | `faan1` | to return / go back / reverse | `05-time-continuous.md` | 4 |
...
| **今日** | `gam1jat6` | today | `00-pronunciation-jyutping.md` | 33 |
| **今晚** | `gam1maan5` | tonight | `22-entertainment-nightlife.md` | 1 |
| **噉** | `gam2` | then / in that case / so | `05-time-continuous.md` | 16 |
...
| **幾** | `gei2` | quite / pretty / fairly | `21-housing-neighborhood.md` | 2 |
...
| **工** | `gung1` | work / job | `05-time-continuous.md` | 4 |
| **公司** | `gung1si1` | company / office | `04-existentials-places.md` | 13 |
...
| **吓** | `haa2` | what / sentence-final particle expressing surprise, disbelief, or seeking quick confirmation | `00-pronunciation-jyutping.md` | 11 |
...
| **係** | `hai6` | to be / to be (am/is/are) / yes | `01-greetings.md` | 55 |
| **係唔係** | `hai6 m4 hai6` | is it or not / is it or not? / is that right? (A-not-A question form) | `01-greetings.md` | 7 |
| **係呀** | `hai6aa3` | yes | `22-entertainment-nightlife.md` | 1 |
...
| **好** | `hou2` | good / fine / very / quite / okay | `01-greetings.md` | 61 |
...
| **好似** | `hou2ci5` | seem / seem like / as if | `11-narrative-cohesion.md` | 2 |
...
| **有** | `jau5` | to have / there is / to have / there is / there are | `04-existentials-places.md` | 21 |
...
| **有冇** | `jau5mou5` | is there / do you have / is there / have or not / is there / do you have (A-not-A question form) | `04-existentials-places.md` | 5 |
...
| **應該** | `jing1goi1` | should / ought to | `08-particles-nuance.md` | 2 |
...
| **要** | `jiu3` | to want / need / must / demand / need / have to | `02-shopping-slang.md` | 33 |
...
| **完** | `jyun4` | finish / finished / complete | `17-foodie-slang.md` | 3 |
...
| **琴晚** | `kam4maan5` | last night | `22-entertainment-nightlife.md` | 3 |
...
| **啦** | `laa1` | particle / sentence-final particle suggesting, requesting, or encouraging action | `00-pronunciation-jyutping.md` | 112 |
...
| **唔** | `m4` | not / not / no (negative prefix) | `00-pronunciation-jyutping.md` | 66 |
...
| **冇問題** | `mou5 man6tai4` | no problem / without issue | `21-housing-neighborhood.md` | 1 |
...
| **你** | `nei5` | you / your | `00-pronunciation-jyutping.md` | 118 |
...
| **我** | `ngo5` | I / I / me | `00-pronunciation-jyutping.md` | 198 |
...
| **寫** | `se2` | to write | `06-ability-experience.md` | 1 |
...
| **食** | `sik6` | to eat | `00-pronunciation-jyutping.md` | 38 |
...
| **想** | `soeng2` | want to / to want to / would like to / think / to want / would like to | `00-pronunciation-jyutping.md` | 46 |
...
| **太** | `taai3` | too | `18-shopping-bargaining.md` | 1 |
| **太多** | `taai3do1` | too much | `22-entertainment-nightlife.md` | 3 |
| **睇** | `tai2` | to look / see / to look / see / watch / read / to watch / look / see / read | `04-existentials-places.md` | 6 |
...
| **添** | `tim1` | particle indicating in addition / as well / furthermore / as well / also / particle | `11-narrative-cohesion.md` | 10 |
...
| **聽日** | `ting1jat6` | tomorrow | `05-time-continuous.md` | 15 |
...
| **同埋** | `tung4maai4` | and / with / together with | `02-shopping-slang.md` | 13 |
| **同事** | `tung4si6` | colleague | `16-workplace-slang.md` | 3 |
| **屋** | `uk1` | house / room | `21-housing-neighborhood.md` | 1 |
| **屋企** | `uk1kei2` | home | `22-entertainment-nightlife.md` | 1 |
| **哇** | `waa1` | wow / whoa | `09-split-verbs-idioms.md` | 5 |
| **話** | `waa6` | to say / tell / words / speech / to scold | `08-particles-nuance.md` | 21 |
| **或者** | `waak6ze2` | perhaps / or | `22-entertainment-nightlife.md` | 1 |
| **玩** | `waan2` | to play / have fun / enjoy | `10-hypotheticals-conditionals.md` | 12 |
| **環境** | `waan4ging2` | environment / surroundings | `21-housing-neighborhood.md` | 4 |
| **位** | `wai2` | seat | `17-foodie-slang.md` | 1 |
| **喂** | `wai2` | hey / hey! / hey / hello (typically answering phone or calling for attention) | `00-pronunciation-jyutping.md` | 8 |
...
| **喎** | `wo3` | sentence-final particle indicating reported speech, surprise, or warning | `07-comparatives-descriptors.md` | 19 |
| **會** | `wui5` | will / would / can / be able to / will / would / can / know how to / meet / will / can / able to | `06-ability-experience.md` | 17 |
...
| **真係** | `zan1hai6` | really / truly | `08-particles-nuance.md` | 23 |
...
| **咗** | `zo2` | verbal aspect suffix indicating completed action (perfective aspect) / completed aspect | `03-dining-out.md` | 77 |
...
| **祝** | `zuk1` | to wish / congratulate | `12-regrets-wishes-empathy.md` | 7 |
...
| **仲** | `zung6` | still / yet / still / also / even more | `08-particles-nuance.md` | 13 |
