...
| :--- | :--- | :--- | :--- | :--- |
| **呀** | `aa3` | particle / sentence-final particle softening statements, making questions friendly | `00-pronunciation-jyutping.md` | 286 |
| **阿** | `aa3` | prefix | `16-workplace-slang.md` | 1 |
| **阿明** | `aa3 ming4` | Ah Ming | `22-entertainment-nightlife.md` | 3 |
...
| **不過** | `bat1gwo3` | but / however | `21-housing-neighborhood.md` | 3 |
| **不如** | `bat1jyu4` | how about | `14-intensifiers-exaggeration.md` | 2 |
| **俾** | `bei2` | to give / for / by / to give / to give / for / let / allow | `10-hypotheticals-conditionals.md` | 26 |
...
| **部** | `bou6` | measure word for machines/phones | `13-passives-focus-indirect.md` | 2 |
...
| **慘** | `caam2` | miserable / pitiful / tragic | `12-regrets-wishes-empathy.md` | 10 |
...
| **全部** | `cyun4bou6` | all / entirely | `14-intensifiers-exaggeration.md` | 13 |
...
| **得** | `dak1` | particle expressing permission, possibility, capability, or adverbial degree | `06-ability-experience.md` | 19 |
...
| **等** | `dang2` | wait / to wait / to wait / wait for | `17-foodie-slang.md` | 4 |
...
| **點樣** | `dim2joeng6` | how / in what way | `07-comparatives-descriptors.md` | 6 |
...
| **電話** | `din6waa2` | telephone / phone | `04-existentials-places.md` | 5 |
...
| **多** | `do1` | many / much / more | `07-comparatives-descriptors.md` | 6 |
| **多謝** | `do1ze6` | thank you (for a gift, compliment, or hospitality) / thank you (for a gift) | `02-shopping-slang.md` | 6 |
| **都** | `dou1` | also / both / all / also / even | `11-narrative-cohesion.md` | 18 |
...
| **返** | `faan1` | to return / go back / reverse | `05-time-continuous.md` | 7 |
...
| **方便** | `fong1bin6` | convenient | `21-housing-neighborhood.md` | 4 |
| **房** | `fong2` | room / bedroom | `04-existentials-places.md` | 12 |
| **放** | `fong3` | to release / let go / put | `09-split-verbs-idioms.md` | 2 |
...
| **覆** | `fuk1` | to reply / write back | `19-social-media-slang.md` | 1 |
...
| **間** | `gaan1` | classifier for buildings / shops / rooms | `21-housing-neighborhood.md` | 3 |
...
| **今日** | `gam1jat6` | today | `00-pronunciation-jyutping.md` | 35 |
| **今晚** | `gam1maan5` | tonight | `22-entertainment-nightlife.md` | 1 |
| **噉** | `gam2` | then / in that case / so | `05-time-continuous.md` | 18 |
...
| **嘅** | `ge3` | particle / possessive particle / nominalizing particle / final assertive particle / associative particle | `00-pronunciation-jyutping.md` | 54 |
| **幾** | `gei2` | quite / pretty / fairly | `21-housing-neighborhood.md` | 4 |
...
| **記得** | `gei3dak1` | to remember | `23-health-sickness.md` | 3 |
...
| **個** | `go3` | general measure word / individual / unit / measure word for general items | `02-shopping-slang.md` | 54 |
...
| **吓** | `haa5` | verbal suffix indicating a brief action or attempt | `23-health-sickness.md` | 2 |
...
| **喺** | `hai2` | at / in / on / at / in / on (locative preposition) | `04-existentials-places.md` | 62 |
| **喺度** | `hai2dou6` | here | `16-workplace-slang.md` | 1 |
| **係** | `hai6` | to be / to be (am/is/are) / yes | `01-greetings.md` | 56 |
| **係唔係** | `hai6 m4 hai6` | is it or not / is it or not? / is that right? (A-not-A question form) | `01-greetings.md` | 8 |
| **係呀** | `hai6aa3` | yes | `22-entertainment-nightlife.md` | 2 |
...
| **可以** | `ho2ji5` | can / may / possible | `06-ability-experience.md` | 20 |
| **可樂** | `ho2lok6` | cola / Coke | `02-shopping-slang.md` | 2 |
| **可唔可以** | `ho2m4ho2ji5` | can or cannot / may or may not (A-not-A question form) | `23-health-sickness.md` | 2 |
...
| **開** | `hoi1` | to write (a prescription) / prescribe / open / start | `23-health-sickness.md` | 3 |
...
| **好** | `hou2` | good / fine / very / quite / okay | `01-greetings.md` | 63 |
...
| **入面** | `jap6min6` | inside | `04-existentials-places.md` | 10 |
...
| **有** | `jau5` | to have / there is / to have / there is / there are / to have / possess / there is / there are | `04-existentials-places.md` | 22 |
...
| **有冇** | `jau5mou5` | is there / do you have / is there / have or not / is there / do you have (A-not-A question form) | `04-existentials-places.md` | 6 |
...
| **依家** | `ji1gaa1` | now / now / currently | `05-time-continuous.md` | 9 |
...
| **要** | `jiu3` | to want / need / must / demand / need / have to / to want / need / require | `02-shopping-slang.md` | 35 |
...
| **完** | `jyun4` | finish / finished / complete | `17-foodie-slang.md` | 4 |
...
| **佢** | `keoi5` | he / she / it / him | `01-greetings.md` | 69 |
| **佢哋** | `keoi5dei6` | they / them | `01-greetings.md` | 12 |
| **傾** | `king1` | to talk / chat | `09-split-verbs-idioms.md` | 1 |
| **啦** | `laa1` | particle / sentence-final particle suggesting, requesting, or encouraging action | `00-pronunciation-jyutping.md` | 116 |
...
| **囉** | `lo1` | sentence-final particle showing obviousness, resignation, or 'of course' / obviousness particle / sentence-final particle expressing obviousness or mild resignation | `04-existentials-places.md` | 44 |
...
| **唔** | `m4` | not / not / no (negative prefix) | `00-pronunciation-jyutping.md` | 68 |
...
| **唔使** | `m4sai2` | no need / not necessary | `23-health-sickness.md` | 1 |
...
| **嘛** | `maa3` | sentence-final particle indicating a statement is an obvious truth or reminder | `08-particles-nuance.md` | 10 |
| **埋** | `maai4` | also | `18-shopping-bargaining.md` | 1 |
| **買** | `maai5` | to buy | `02-shopping-slang.md` | 16 |
| **埋單** | `maai5daan1` | to pay the bill / get the check / pay bill | `03-dining-out.md` | 3 |
| **賣** | `maai6` | sell | `18-shopping-bargaining.md` | 1 |
...
| **咩** | `me1` | sentence-final particle expressing rhetorical doubt, surprise, or sarcasm / what / sentence-final particle expressing rhetorical doubt, surprise, or sarcasm / rhetorical final particle indicating doubt | `05-time-continuous.md` | 33 |
| **咩嘢** | `me1je5` | what / what kind of thing | `01-greetings.md` | 9 |
| **美國** | `mei5gwok3` | United States / America | `01-greetings.md` | 4 |
| **未** | `mei6` | not yet / have not | `03-dining-out.md` | 8 |
...
| **冇** | `mou5` | not to have / without / there is not / not to have / there is not / not have / to not have / there is not / have not | `02-shopping-slang.md` | 32 |
| **舞** | `mou5` | dance | `09-split-verbs-idioms.md` | 1 |
| **冇問題** | `mou5 man6tai4` | no problem / without issue | `21-housing-neighborhood.md` | 2 |
...
| **你** | `nei5` | you / your | `00-pronunciation-jyutping.md` | 131 |
...
| **我** | `ngo5` | I / I / me | `00-pronunciation-jyutping.md` | 209 |
...
| **呢個** | `ni1go3` | this one | `02-shopping-slang.md` | 17 |
...
| **先** | `sin1` | first / beforehand / only then / first / only then | `06-ability-experience.md` | 5 |
...
| **鎖匙** | `so2si4` | key | `04-existentials-places.md` | 1 |
| **想** | `soeng2` | want to / to want to / would like to / think / to want / would like to | `00-pronunciation-jyutping.md` | 49 |
...
| **太** | `taai3` | too / too / extremely | `18-shopping-bargaining.md` | 2 |
| **太多** | `taai3do1` | too much | `22-entertainment-nightlife.md` | 3 |
| **睇** | `tai2` | to look / see / to look / see / watch / read / to watch / look / see / read | `04-existentials-places.md` | 8 |
...
| **條** | `tiu4` | measure word for long, thin objects | `18-shopping-bargaining.md` | 8 |
...
| **同埋** | `tung4maai4` | and / with / together with | `02-shopping-slang.md` | 20 |
| **同事** | `tung4si6` | colleague | `16-workplace-slang.md` | 3 |
| **屋** | `uk1` | house / room | `21-housing-neighborhood.md` | 1 |
| **屋企** | `uk1kei2` | home / home / house | `22-entertainment-nightlife.md` | 2 |
| **哇** | `waa1` | wow / whoa | `09-split-verbs-idioms.md` | 6 |
| **話** | `waa6` | to say / tell / words / speech / to scold | `08-particles-nuance.md` | 21 |
| **或者** | `waak6ze2` | perhaps / or | `22-entertainment-nightlife.md` | 1 |
...
| **喎** | `wo3` | sentence-final particle indicating reported speech, surprise, or warning | `07-comparatives-descriptors.md` | 20 |
| **會** | `wui5` | will / would / can / be able to / will / would / can / know how to / meet / will / can / able to | `06-ability-experience.md` | 18 |
...
| **真係** | `zan1hai6` | really / truly | `08-particles-nuance.md` | 24 |
...
| **就** | `zau6` | then / right away / immediately | `10-hypotheticals-conditionals.md` | 20 |
...
| **咗** | `zo2` | verbal aspect suffix indicating completed action (perfective aspect) / completed aspect | `03-dining-out.md` | 82 |
...
| **做** | `zou6` | to do / make / perform | `05-time-continuous.md` | 5 |
