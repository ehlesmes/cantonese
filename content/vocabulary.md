...
| :--- | :--- | :--- | :--- | :--- |
| **呀** | `aa3` | particle / sentence-final particle softening statements, making questions friendly | `00-pronunciation-jyutping.md` | 257 |
...
| **不過** | `bat1gwo3` | but / however | `21-housing-neighborhood.md` | 2 |
...
| **差唔多** | `caa1m4do1` | almost / about / more or less | `21-housing-neighborhood.md` | 1 |
...
| **唱** | `coeng3` | to sing | `09-split-verbs-idioms.md` | 4 |
...
| **都** | `dou1` | also / both / all | `11-narrative-cohesion.md` | 16 |
...
| **放飛機** | `fong3fei1gei1` | to stand someone up / break a promise | `09-split-verbs-idioms.md` | 1 |
...
| **噉** | `gam2` | then / in that case / so | `05-time-continuous.md` | 14 |
...
| **嘅** | `ge3` | particle / possessive particle / nominalizing particle / final assertive particle / associative particle | `00-pronunciation-jyutping.md` | 52 |
| **幾** | `gei2` | quite / pretty / fairly | `21-housing-neighborhood.md` | 1 |
...
| **個** | `go3` | general measure word / individual / unit / measure word for general items | `02-shopping-slang.md` | 52 |
| **覺得** | `gok3dak1` | to feel / think | `07-comparatives-descriptors.md` | 4 |
...
| **攰** | `gui6` | tired / exhausted | `13-passives-focus-indirect.md` | 5 |
...
| **去** | `heoi3` | to go | `04-existentials-places.md` | 54 |
...
| **開心** | `hoi1sam1` | happy / glad / cheerful | `11-narrative-cohesion.md` | 8 |
| **學校** | `hok6haau6` | school | `04-existentials-places.md` | 2 |
| **學生** | `hok6saang1` | student | `08-particles-nuance.md` | 3 |
| **好** | `hou2` | good / fine / very / quite / okay | `01-greetings.md` | 60 |
...
| **一齊** | `jat1cai4` | together | `09-split-verbs-idioms.md` | 4 |
...
| **有** | `jau5` | to have / there is / to have / there is / there are | `04-existentials-places.md` | 19 |
...
| **完** | `jyun4` | finish | `17-foodie-slang.md` | 1 |
...
| **佢** | `keoi5` | he / she / it / him | `01-greetings.md` | 65 |
...
| **唔** | `m4` | not / not / no (negative prefix) | `00-pronunciation-jyutping.md` | 63 |
...
| **你** | `nei5` | you / your | `00-pronunciation-jyutping.md` | 117 |
...
| **我哋** | `ngo5dei6` | we / us | `01-greetings.md` | 31 |
...
| **十** | `sap6` | ten | `00-pronunciation-jyutping.md` | 18 |
...
| **食** | `sik6` | to eat | `00-pronunciation-jyutping.md` | 37 |
...
| **宵夜** | `siu1je2` | late night snack | `17-foodie-slang.md` | 4 |
...
| **想** | `soeng2` | want to / to want to / would like to / think / to want / would like to | `00-pronunciation-jyutping.md` | 44 |
...
| **睇書** | `tai2syu1` | to read books | `09-split-verbs-idioms.md` | 2 |
...
| **同埋** | `tung4maai4` | and / with / together with | `02-shopping-slang.md` | 12 |
| **同事** | `tung4si6` | colleague | `16-workplace-slang.md` | 3 |
| **屋** | `uk1` | house / room | `21-housing-neighborhood.md` | 1 |
| **哇** | `waa1` | wow / whoa | `09-split-verbs-idioms.md` | 4 |
| **話** | `waa6` | to say / tell / words / speech / to scold | `08-particles-nuance.md` | 21 |
| **玩** | `waan2` | to play / have fun / enjoy | `10-hypotheticals-conditionals.md` | 11 |
...
| **真係** | `zan1hai6` | really / truly | `08-particles-nuance.md` | 21 |
...
| **咗** | `zo2` | verbal aspect suffix indicating completed action (perfective aspect) / completed aspect | `03-dining-out.md` | 74 |
