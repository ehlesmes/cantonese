...
description: >
  Master colloquial Cantonese terms for salary payments, MPF, mortgages, loans,
  debts, and hitting targets.
---

In this chapter, we will learn about **Mortgages, Loans & Getting Paid**.

Discussing salaries, paying bills, and managing loans is an essential part of
daily life in Hong Kong. We will learn standard and highly frequent colloquial
terms for these situations.

Let's dive in!

---

## 1. Mortgages, Loans & Targets

Here is the essential vocabulary for managing bills, loans, and salary in
Cantonese:
...
- `供樓[gung1lau2|to pay a mortgage]`: To pay a mortgage or make housing
  installments.
  - _Example_: `佢[keoi5|he / she / it]` `每[mui5|every]`
    `個[go3|general measure word / individual / unit]` `月[jyut6|month]`
...
## 2. Situational Dialogue: Mortgage and Loan Talk
...
A: 係呀[hai6aa3|yes]，依家[ji1gaa1|now] 供樓[gung1lau2|to pay a mortgage] 真係[zan1hai6|really / truly] 貴[gwai3|expensive] 呀[aa3|sentence-final particle softening statements, making questions friendly]。好彩[hou2coi2|luckily] 每[mui5|every] 個[go3|general measure word / individual / unit] 月[jyut6|month] 出糧[ceot1loeng4|getting paid / salary] 都[dou1|also / even / already] 幾[gei2|quite / pretty / fairly] 準時[zeon2si4|punctual / on time] 嘅[ge3|possessive or linking particle]。
...
Test your understanding of mortgages, salaries, and loans in Cantonese.

```exercise
question: |
  Which Cantonese phrase refers to getting paid one's salary?
  A) 強積金[koeng5zik1gam1|MPF]
  B) 出糧[ceot1loeng4|getting paid]
  C) 供樓[gung1lau2|paying mortgage]
answer: B
explanation: |
  `出糧[ceot1loeng4|getting paid one's salary]` literally translates to "producing grain" and is the colloquial Cantonese term for getting paid one's salary.
```
...
answer: 佢[keoi5|he / she / it] 每[mui5|every] 個[go3|general measure word / individual / unit] 月[jyut6|month] 要[jiu3|need] 供樓[gung1lau2|to pay a mortgage] 呀[aa3|sentence-final particle softening statements, making questions friendly]。
explanation: |
  `佢[keoi5|he / she / it]` is "he", `每[mui5|every] 個[go3|classifier] 月[jyut6|month]` is "every month", `要[jiu3|need]` is "need to", `供樓[gung1lau2|to pay a mortgage]` is "pay mortgage", and `呀[aa3|particle]` is the SFP.
```
