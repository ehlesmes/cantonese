...
chapters:
  ...
  - id: "market-bargaining"
    ...
    file: "market-bargaining.md"
  - id: "shopping-classifiers"
    title: "Clothing & Shopping Classifiers"
    file: "shopping-classifiers.md"
  - id: "relationship-codes"
    title: "Modern Romance & Relationship Codes"
    file: "relationship-codes.md"
  - id: "flirting-slang"
    title: "Flirting & soldiering Slang"
    file: "flirting-slang.md"
  - id: "social-media-slang"
    title: "Social Media & Messaging Slang"
    file: "social-media-slang.md"
  - id: "housing-types"
    title: "Types of Housing & Apartments"
    file: "housing-types.md"
  - id: "flat-hunting"
  ...
  - id: "device-basics"
    title: "Internet & Device Basics"
    file: "device-basics.md"
  - id: "smart-home"
    title: "Smart Home & Tech Crises"
    file: "smart-home.md"
  - id: "banking-savings"
    title: "Banking & Savings"
    file: "banking-savings.md"
  - id: "payments-bills"
    title: "Mortgages, Loans & Getting Paid"
    file: "payments-bills.md"
...
1. **Active Look-Ahead Window**: We focus on a **3-chapter locked window** to
   maintain high detail.
2. **Linguistic Feedback Loop**: At the end of each generated chapter, the
   authoring LLM will review the cognitive load and suggest splits, expansions,
   or ordering changes to the remaining tentative roadmap.
3. **Agile Backlog**: Future topics adapt based on learner pace and the organic
   complexity of the language as it is introduced.
