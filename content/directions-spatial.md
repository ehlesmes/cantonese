...
description: >
  Master spatial directional markers to specify locations, and learn how to use
  the obviousness particle lo in Cantonese.
---

In this lesson, we will transition to specifying relative positions in space
(e.g. "underneath", "behind", "next to") and using the highly expressive
obviousness particle lo.

Let's dive in!

---

## 1. Spatial Directions & Relative Position
...
## 3. Situational Dialogue: Where Are My Car Keys?
